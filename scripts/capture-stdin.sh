...
ORIGINAL='bash /Users/bartturczynski/.claude/statusline-command.sh'
FIXTURE='/Users/bartturczynski/Projects/temper/fixtures/subscriber.golden.json'
...
printf '%s' "$IN" | bash /Users/bartturczynski/.claude/statusline-command.sh
